...
('siteselect', 'Advance Supporting Membership Fee for the 2021 Worldcon', 'siteselect', false, ARRAY['token'], '<p>You (or someone else you pay for) will receive a <b>voting token</b> to be entered on the site selection ballot as proof of payment, which will allow you to submit a vote for where the 79th Worldcon will be held in 2021. You can vote in advance by postal mail or in person at Dublin2019, an Irish Worldcon. Your ballot will NOT be counted unless you provide this proof of payment of the Advance Supporting Membership Fee for the 2021 Worldcon. You will receive your voting token via email.</p><p><b>Worldcon Site Selection Ballot</b>: <a href="http://www.dublin2019.com/wsfs/site-selection/" target="_blank">Click here</a> to find a printable copy of the Worldcon Site Selection ballot to download.</p>'),
...
('new_member', 'FirstWorldcon', 13000, 'Residents of the Island of Ireland First Worldcon', 1),
